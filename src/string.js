...
module.exports = {
  toInt: value => {
    ...
    throw new Error('toInt function has incompatible value.')
  },
  dos2unix: value => {
    ...
    throw new Error('Dos2unix function has incompatible value.')
  },
  capitalize: value => {
    ...
    throw new Error('Capitalize function has incompatible value.')
  },
  excerpt: (data, nwords) => {
  ...
  toJSON: value => {
    ...
    throw new Error('toJSON function has incompatible value.')
  },
  json: value => {
    if (type.isEmpty(value)) throw new Error('toJSON function needs an string value.')
    else if (type.isString(value)) return JSON.parse(value)
  ...
  split: (value, separator, limit) => {
    ...
    throw new Error('Split function has incompatible value.')
  },
  toLowerCase: value => {
    ...
    throw new Error('toLowerCase function has incompatible value.')
  },
  toUpperCase: value => {
  ...
  replace: (value, oldregex, newstr) => {
    ...
    throw new Error('replace function has incompatible value.')
  },
